% Hamiltonian for an armchair nanoribbon
% Input:
% % x, composition
% % n, strain parameter
...
function [k, V] = HamiltonianArmchair(x, n, f, uc, stagg, kpoints)
% 
tor = 0;
N_at = 4*uc + 8;
...
H_NN_TYP0_stagg=zeros(N_at,N_at);
H_NN_TYP0_stagg(1,1)=1;
H_NN_TYP0_stagg(2,2)=-1;
H_NN_TYP0_stagg(3,3)=-1;
H_NN_TYP0_stagg(4,4)=1;
for j=1:uc
    H_NN_TYP0_stagg(1+4*j,1+4*j)=1;
    H_NN_TYP0_stagg(2+4*j,2+4*j)=-1;
    H_NN_TYP0_stagg(3+4*j,3+4*j)=-1;
    H_NN_TYP0_stagg(4+4*j,4+4*j)=1;  
end
[s1,s2]=size(TYP0);
H_NN_TYP0_full=zeros(s1*N_at,s1*N_at);
H_NN_TYP0_stagg_full=kron(H_NN_TYP0_stagg,stagg.*eye(8,8));
H_NN_TYP0_full=kron(H_NN_TYP0,TYP0)+H_NN_TYP0_stagg_full;
...
for i = 1:kpoints
    ...
    H_NN_TYP1(5,7)=1;
    for j=1:uc
        H_NN_TYP1(8+4*(j-1),10+4*(j-1))=1;
        H_NN_TYP1(9+4*(j-1),11+4*(j-1))=1;
    end
    H_NN_TYP1(N_at,2)=tor;
    ...
    H_NN_TYP2(8,6)=1;
    for j=1:uc
        H_NN_TYP2(9+4*(j-1),7+4*(j-1))=1;
        H_NN_TYP2(12+4*(j-1),10+4*(j-1))=1;
    end
    H_NN_TYP2(1,N_at-1)=tor;
    H_NN_TYP2_full=zeros(s1*N_at,s1*N_at);
    H_NN_TYP2_full=kron(H_NN_TYP2,TYP2)+kron(H_NN_TYP2',TYP2');

    H_NN_TYP3=zeros(N_at,N_at);
    H_NN_TYP3(1,2)=1;
    H_NN_TYP3(4,3)=exp(1i*k(i)*a);
    H_NN_TYP3(5,6)=1;
    H_NN_TYP3(8,7)=exp(1i*k(i)*a);
    for j=1:uc
        H_NN_TYP3(9+4*(j-1),10+4*(j-1))=1;
        H_NN_TYP3(12+4*(j-1),11+4*(j-1))=exp(1i*k(i)*a);
    end
...
% % Hamiltonian: NNN
    H_NNN_TYP1N=zeros(N_at,N_at);
    H_NNN_TYP1N(1,5)=1;
    H_NNN_TYP1N(2,6)=1;
    H_NNN_TYP1N(3,7)=1;
    H_NNN_TYP1N(4,8)=1;
    for j=1:uc
        H_NNN_TYP1N(5+4*(j-1),9+4*(j-1))=1;
        H_NNN_TYP1N(6+4*(j-1),10+4*(j-1))=1;
        H_NNN_TYP1N(7+4*(j-1),11+4*(j-1))=1;
        H_NNN_TYP1N(8+4*(j-1),12+4*(j-1))=1;
    end
    H_NNN_TYP1N(N_at-3, 1)=tor;
    H_NNN_TYP1N(N_at-2, 2)=tor;
    H_NNN_TYP1N(N_at-1, 3)=tor;
    H_NNN_TYP1N(N_at,4)=tor;
    H_NNN_TYP1N_full=zeros(s1*N_at,s1*N_at);
    H_NNN_TYP1N_full=kron(H_NNN_TYP1N,TYP1N);

    H_NNN_TYP2N=zeros(N_at,N_at);
    H_NNN_TYP2N(5,1)=1;
    H_NNN_TYP2N(6,2)=1;
    H_NNN_TYP2N(7,3)=1;
    H_NNN_TYP2N(8,4)=1;
    for j=1:uc
        H_NNN_TYP2N(9+4*(j-1),5+4*(j-1))=1;
        H_NNN_TYP2N(10+4*(j-1),6+4*(j-1))=1;
        H_NNN_TYP2N(11+4*(j-1),7+4*(j-1))=1;
        H_NNN_TYP2N(12+4*(j-1),8+4*(j-1))=1;
    end
    H_NNN_TYP2N(1,N_at-3)=tor;
    H_NNN_TYP2N(2,N_at-2)=tor;
    H_NNN_TYP2N(3,N_at-1)=tor;
    H_NNN_TYP2N(4,N_at)=tor;
    H_NNN_TYP2N_full=zeros(s1*N_at,s1*N_at);
    H_NNN_TYP2N_full=kron(H_NNN_TYP2N,TYP2N);

    H_NNN_TYP3N=zeros(N_at,N_at);
    H_NNN_TYP3N(3,2)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP3N(4,1)=1;
    H_NNN_TYP3N(5,4)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP3N(6,3)=1;
    H_NNN_TYP3N(7,6)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP3N(8,5)=1;
    for j=1:uc
        H_NNN_TYP3N(9+4*(j-1),8+4*(j-1))=1.*exp(-1i*k(i)*a);
        H_NNN_TYP3N(10+4*(j-1),7+4*(j-1))=1;
        H_NNN_TYP3N(11+4*(j-1),10+4*(j-1))=1.*exp(-1i*k(i)*a);
        H_NNN_TYP3N(12+4*(j-1),9+4*(j-1))=1;
    end
    H_NNN_TYP3N(1,N_at)=tor.*exp(-1i*k(i)*a);
    H_NNN_TYP3N(2,N_at-1)=tor;
    H_NNN_TYP3N_full=zeros(s1*N_at,s1*N_at);
    H_NNN_TYP3N_full=kron(H_NNN_TYP3N,TYP3N);

    H_NNN_TYP4N=zeros(N_at,N_at);
    H_NNN_TYP4N(1,4)=1;
    H_NNN_TYP4N(2,3)=1.*exp(1i*k(i)*a);
    H_NNN_TYP4N(3,6)=1;
    H_NNN_TYP4N(4,5)=1.*exp(1i*k(i)*a);
    H_NNN_TYP4N(5,8)=1;
    H_NNN_TYP4N(6,7)=1.*exp(1i*k(i)*a);
    for j=1:uc
        H_NNN_TYP4N(7+4*(j-1),10+4*(j-1))=1;
        H_NNN_TYP4N(8+4*(j-1),9+4*(j-1))=1.*exp(1i*k(i)*a);
        H_NNN_TYP4N(9+4*(j-1),12+4*(j-1))=1;
        H_NNN_TYP4N(10+4*(j-1),11+4*(j-1))=1.*exp(1i*k(i)*a);
    end
    H_NNN_TYP4N(N_at-1,2)=tor;
    H_NNN_TYP4N(N_at,1)=tor.*exp(1i*k(i)*a);
    H_NNN_TYP4N_full=zeros(s1*N_at,s1*N_at);
    H_NNN_TYP4N_full=kron(H_NNN_TYP4N,TYP4N);

    H_NNN_TYP5N=zeros(N_at,N_at);
    H_NNN_TYP5N(1,4)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP5N(2,3)=1;
    H_NNN_TYP5N(4,5)=1;
    H_NNN_TYP5N(3,6)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP5N(5,8)=1.*exp(-1i*k(i)*a);
    H_NNN_TYP5N(6,7)=1;
    for j=1:uc
        H_NNN_TYP5N(7+4*(j-1),10+4*(j-1))=1.*exp(-1i*k(i)*a);
        H_NNN_TYP5N(8+4*(j-1),9+4*(j-1))=1;
        H_NNN_TYP5N(9+4*(j-1),12+4*(j-1))=1.*exp(-1i*k(i)*a);
        H_NNN_TYP5N(10+4*(j-1),11+4*(j-1))=1;
    end
    H_NNN_TYP5N(N_at-1,2)=tor.*exp(-1i*k(i)*a);
    H_NNN_TYP5N(N_at,1)=tor;
    H_NNN_TYP5N_full=zeros(s1*N_at,s1*N_at);
    H_NNN_TYP5N_full=kron(H_NNN_TYP5N,TYP5N);

    H_NNN_TYP6N=zeros(N_at,N_at);
    H_NNN_TYP6N(3,2)=1;
    H_NNN_TYP6N(4,1)=1.*exp(1i*k(i)*a);
    H_NNN_TYP6N(5,4)=1;
    H_NNN_TYP6N(6,3)=1.*exp(1i*k(i)*a);
    H_NNN_TYP6N(7,6)=1;
    H_NNN_TYP6N(8,5)=1.*exp(1i*k(i)*a);
    for j=1:uc
        H_NNN_TYP6N(9+4*(j-1),8+4*(j-1))=1;
        H_NNN_TYP6N(10+4*(j-1),7+4*(j-1))=1.*exp(1i*k(i)*a);
        H_NNN_TYP6N(11+4*(j-1),10+4*(j-1))=1;
        H_NNN_TYP6N(12+4*(j-1),9+4*(j-1))=1.*exp(1i*k(i)*a);
    end
    H_NNN_TYP6N(1,N_at)=tor;
    H_NNN_TYP6N(2,N_at-1)=tor.*exp(1i*k(i)*a);
